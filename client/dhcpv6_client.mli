...
val create : ?with_xid : Cstruct.uint32 -> ?requests : Dhcpv6_wire.option_code list -> Macaddr.t -> (t * buffer)
...
val input : t -> buffer -> [`Response of (t * buffer) | `New_lease of (t * Dhcpv6_wire.pkt) | `Noop ]
...
val lease : t -> Dhcpv6_wire.pkt option
